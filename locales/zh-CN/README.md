...
Roo Code 3.18 基于您的反馈带来强大的新功能和改进！

- **Gemini 2.5 Flash 预览模型** - 访问最新的 Gemini Flash 模型，获得更快速、更高效的响应。
- **智能上下文压缩按钮** - 任务头部的新按钮让您能够智能压缩内容，并提供视觉反馈。
- **模式定义的 YAML 支持** - 通过 YAML 支持更轻松地创建和自定义模式。
