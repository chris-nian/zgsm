...
Roo Code 3.18はユーザーのフィードバックに基づく強力な新機能と改善を提供します！

- **Gemini 2.5 Flashプレビューモデル** - より高速で効率的な応答のための最新のGemini Flashモデルにアクセス
- **インテリジェントなコンテキスト凝縮ボタン** - タスクヘッダーに新しいボタンが追加され、視覚的なフィードバックと共にコンテンツをインテリジェントに凝縮できます
- **モード定義のためのYAMLサポート** - YAMLサポートによりモードをより簡単に作成・カスタマイズ
